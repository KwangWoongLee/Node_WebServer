...
code.game_packet.agreement = 105; // 여러가지 동의

code.game_packet.item_list = 201; // 아이템 리스트
code.game_packet.get_exp = 203; // 경험치 확인

code.game_packet.unit_list = 301; // 유닛 리스트
code.game_packet.unit_trans = 303; // 마음=>유닛 교환
...
code.error.not_found_my_exp = -1033; // 경험치가 존재하지 않습니다.
code.error.not_found_item = -1034; // 해당 아이템이 존재하지 않습니다.

code.error.deficient_item = -1035; // 아이템이 부족합니다.
code.error.not_found_unit_item = -1036; // 해당 아이템이 유닛 교환 아이템이 아닙니다.
