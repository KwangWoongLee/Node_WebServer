...
exports.get_item_list = function (userdb, aidx) {
  return new Promise(function (resolve, reject) {
    const query = 'select idx, item_code, item_cnt from dat_item where aidx = ? and item_code != ?';
...
exports.get_exp = function (userdb, aidx) {
  return new Promise(function (resolve, reject) {
    const query = 'select item_cnt as exp from dat_item where aidx = ? and item_code = ?';
...
exports.get_item = function (userdb, aidx, item_idx) {
  return new Promise(function (resolve, reject) {
    const query = 'select item_code, item_cnt from dat_item where idx = ? and aidx = ?';
